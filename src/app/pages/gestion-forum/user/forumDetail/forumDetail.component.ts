...
import {reviews} from "../../../learning/courses/overview/data";

@Component({
  selector: 'app-forum',
  standalone: true,
    imports: [CommonModule, AccordionModule, BsDropdownModule, DropzoneModule, FormsModule, ModalModule, RatingModule, ReactiveFormsModule, RouterLink, SharedModule, SimplebarAngularModule],
  templateUrl: './forumDetail.component.html',
  styleUrl: './forumDetail.component.scss'
})
